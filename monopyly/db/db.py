...
def init_db():
    ...
    with current_app.open_resource('db/views.sql') as views:
        db.executescript(views.read().decode('utf8'))
    with current_app.open_resource('db/preloads.sql') as preloads:
        db.executescript(preloads.read().decode('utf8'))
